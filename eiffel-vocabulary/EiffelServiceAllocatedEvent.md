...
The EiffelServiceAllocatedEvent is to declare that the infrastructure needed for a service instance has been allocated to a User. Ex: A global scheduler or Resource booking tool has allocated the the resources to user.
...
## Examples
* [Simple example](../examples/EiffelServiceAllocatedEvent.json)
