...
The EiffelAlertRaisedEvent declares that an incident has occurred, technically regarding any topic,
...
__Type:__ String  
__Required:__ No  
__Description:__ A URI where further information about the incident can be obtained, if available.

### data.entity
__Type:__ String  
__Required:__ No  
__Description:__ The identity of the user or entity that raised the incident.
...
## Examples
* [Simple example](../examples/EiffelAlertRaisedEvent.json)
